...
const PrivacyPolicy = () => {
  return (
    <>
      {" "}
      <section className=" animate-fade-up py-40">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8 text-gray-700">
            <div>
              ...
              <p>
                At <strong>Minutes Global FZ-LLC</strong>, we are committed to
                protecting the privacy and security of our customers, partners,
                and website users. This Privacy Policy outlines how we collect,
                use, and safeguard personal data in compliance with Hong Kong’s
                Personal Data (Privacy) Ordinance (PDPO) and, where applicable,
